...
fatesvar = tribble(
   ...
   , "fates_basalarea"            , "Basal area"                             ,     "0.",            "1.", "m2.2.cm2",     "m2oha",       "cm2",       "total", "sum",   FALSE, NA_character_,     0L, NA_character_,   TRUE,   TRUE,  "cividis",   FALSE,    "log10",   NA_real_,   NA_real_
   ...
   , "fates_lai"                  , "Leaf area index"                        ,     "0.",            "1.",       "1.",    "m2lom2",    "m2lom2", NA_character_, "sum",    TRUE, NA_character_,     0L, NA_character_,   TRUE,   TRUE,     "BuGn",   FALSE, "identity",         0.,        4.5
   ...
   , "fates_nplant"               , "Number density"                         ,     "0.",       "ha.2.m2",       "1.",     "ploha",     "ploha", NA_character_, "sum",    TRUE, NA_character_,     0L, NA_character_,   TRUE,  FALSE,   "YlGnBu",   FALSE,    "log10",   NA_real_,   NA_real_
   , "fates_nplant_canopy"        , "Number density (Canopy)"                ,     "0.",       "ha.2.m2",       "1.",     "ploha",     "ploha", NA_character_, "sum",   FALSE, NA_character_,     0L, NA_character_,   TRUE,  FALSE,   "YlGnBu",   FALSE,    "log10",   NA_real_,   NA_real_
   , "fates_nplant_ustory"        , "Number density (Understory)"            ,     "0.",       "ha.2.m2",       "1.",     "ploha",     "ploha", NA_character_, "sum",   FALSE, NA_character_,     0L, NA_character_,   TRUE,  FALSE,   "YlGnBu",   FALSE,    "log10",   NA_real_,   NA_real_
   ...
   , "fates_vegc_aboveground"     , "Above-ground biomass"                   ,     "0.",            "1.",  "ha.2.m2",    "kgcom2",       "kgc",       "total", "sum",   FALSE, NA_character_,     0L, NA_character_,   TRUE,   TRUE,   "PuBuGn",   FALSE,    "log10",         0.,        22.
)#end tribble
#---~---
