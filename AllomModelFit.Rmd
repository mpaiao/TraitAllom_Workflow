...
-  **AllomFitXIC**. Which information criterion to use when comparing models? Options are AIC (default), BIC or mR2Adj (negative of $R^2$ adjusted for the number of parameters).
...
AllomFitXIC     = c("AIC","BIC","mR2Adj")[2L]
...
AllomMaxItOptim = 10000L  # Maximum number of iterations for finding the optimal point
...
- **UseSizeBins**. Should the training date be resampled by size bins? 
...
```{r,label='plot-fitted-points',message=FALSE,results='hide',warning=FALSE,fig.width=8, fig.height=6}
