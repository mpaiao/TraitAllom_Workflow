...
use_realm  = c("NeoTropical","PanTropical", "WestUS","AfricaTropical", "AsiaTropical")[3L]
...
-  **AllomFitXIC**. Which information criterion to use when comparing models? Options are AIC (default) or BIC.
