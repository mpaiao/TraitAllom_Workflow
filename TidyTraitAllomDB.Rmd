...
extra_file_base = c("LT-Brazil_Extra.csv","FrenchGuiana_Extra.csv"
                   ,"PuertoRico_Extra.csv","TalloNeoTropical.csv","SLBrazil_AllometryData.csv", "tropicstallo_data_subset.csv")
...
Rdata_GeolocationTRY = file.path(rdata_path,paste0("GeolocationTRY_" , use_suffix  ,".RData"))
Rdata_GeodataTRY     = file.path(rdata_path,paste0("GeodataTRY_"     , use_suffix  ,".RData"))
