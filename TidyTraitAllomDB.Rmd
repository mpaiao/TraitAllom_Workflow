...
extra_file_base = c("LT-Brazil_Extra.csv","FrenchGuiana_Extra.csv"
                   ,"PuertoRico_Extra.csv","TalloNeoTropical.csv","SLBrazil_AllometryData.csv", "Tallo_WestUS.csv")
...
use_realm  = c("NeoTropical","PanTropical", "WestUS")[3]
```
...
if (reload_TidyTRY && file.exists(Rdata_RawTRY)){
   ...
   loop_list       = seq(from=file_first,to=n_try_file_list)
