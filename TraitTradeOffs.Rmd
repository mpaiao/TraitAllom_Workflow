...
use_woody_level = c("tree_only","woody_ss_free","woody_ss_all","woody_sl_free","woody_sl_all","all_plants")[5L]
```
...
impute_cluster_test = c(FALSE,TRUE)[2L]
